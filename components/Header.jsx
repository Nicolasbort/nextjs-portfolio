...
export default function Header(props) {
    return (
        ...
        <header className={`text-white text-center bg-lightgray ${styles.header}`} id="header">
            <div className="container d-flex align-items-center flex-column text-darkblue">
            
                <Image className="rounded-circle" src="/picture.jpeg" alt="Picture of the author" width={220} height={220} />
